...
const config = {
    ...
    pack: {
        ...
        bucket: `larva.${app}.stack-${env}-${version}`,
    },
    vars: {
        SlackerStack: 'slacker-production-1',
        SlackCommand: '/echo',
        ConversionBucketName: `larva.${app}.conversion-${env}-${version}`,
        HistoryTableName: 'HeyhoHistories',
    },
    slack: {
        verficationTokenName: '/slack/larva/verification-token',
    },
};
